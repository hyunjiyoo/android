...
public class FragmentMyPage3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_mypage3, container, false);

        fm = getFragmentManager();
        ft = fm.beginTransaction();

        logout_btn2 = (Button) rootView.findViewById(R.id.logout_btn2);
